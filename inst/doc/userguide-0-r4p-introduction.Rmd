...
(<https://docs.r4photobiology.info/>) for HTML documentation. Each
package has its own public Git repository at my GitHub account
(<https://github.com/aphalo/>) from
where the source code of the latest and previous versions can be cloned
or forked.
